...
class MainPageLocators:
    ...
    enter_button = (By.XPATH, '//button[contains(@class, "button_button__33qZ0") and contains(@class, "button_button_type_primary__1O7Bx")]')
    ...
    place_for_ingredients = (By.XPATH, '//section[contains(@class, "BurgerConstructor_basket__29Cd7 mt-25 ")]')
